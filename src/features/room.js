...
import { setConnection } from "./icons-tooltips.js?v=20260904-help-invite-fixes-02";
import {
...
} from "./session-ui.js?v=20260909-keyboard-arrow-27";
...
import {
  ...
  resetPageUnread,
  renderReplyPreview,
} from "./chat/index.js?v=20260909-keyboard-arrow-27";
